...
display_ascii() {
    echo -e "    ${RED} _,  _, ____,  ____,  ____,  ____,  ____,  __, _, ____,  ____,  ____,   ____, ${RESET}"
    echo -e "    ${GREEN}(-|\\ | (-/  \\ (-|  \\ (-|_,  (-(__  (-|_,  (-|\\/| (-|_,  (-(__  (-|     (-/_|  ${RESET}"
    echo -e "    ${BLUE} _| \\|, _\\__/, _|__/  _|__,  ____)  _|__,  _| _|, _|__,  ____)  _|,    _/  |, ${RESET}"
    echo -e "    ${YELLOW}(      (      (      (      (      (      (      (      (      (      (       ${RESET}"
}
...
show_menu() {
    ...
    draw_middle_border
    print_telegram_icon
    echo -e "    ${BLUE}Subscribe to our channel: ${YELLOW}https://t.me/nodesemesta${RESET}"
    draw_middle_border
